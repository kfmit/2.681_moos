...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pPrimeFactor application is used for Calculating          ");
  blk("  the prime factors for a given int                             ");
  blk("                                                                ");
  blk("                                                                ");
  blk("                                                                ");
}
...
void showInterfaceAndExit()
{
  ...
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");
  blk("  PRIME_RESULT = orig=90090,received=34,calculated=33,solve_time");
  blk("               =2.03,primes=2:3:3:5:7:11:13,username=jane       ");
  blk("                                                                ");
  exit(0);
}
